    ...
    <div className="animate-fade-in max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-white rounded-2xl shadow-sm border border-secondary/30 p-8 md:p-12">
        ...
        <div className="space-y-8 text-primary/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-3">2. Use License</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-3">3. Venue Bookings</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-3">4. User Account</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-3">5. Limitations</h2>
            <p>
           ...
           <section>
            <h2 className="text-xl font-bold text-primary mb-3">6. Governing Law</h2>
            <p>
